...
@implementation UIColor (CExtention)

+ (UIColor *)jk_colorWithRGB:(uint32_t)rgbValue {
...
+ (UIColor *)jk_colorWithRGBA:(uint32_t)rgbaValue {
...
+ (UIColor *)jk_colorWithRGB:(uint32_t)rgbValue alpha:(CGFloat)alpha {
    CGFloat red   = (rgbValue & 0xFF0000) >> 16;
    CGFloat green = (rgbValue & 0xFF00) >> 8;
    CGFloat blue  = rgbValue & 0xFF;
